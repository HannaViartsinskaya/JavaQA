...
//        bubbleSort(array);
//        try(FileWriter writer = new FileWriter("exercise1.txt", false))
//        {
...
//
  //      String modifyString="";
//        try {
//            String content = new String(Files.readAllBytes(Paths.get("exercise2.java")), "UTF-8");
...
//            e.printStackTrace();
//        }
//        try(FileWriter fileWriter=new FileWriter("exercise2.java",false))
//        {
...
//        Scanner sc = null;
//        try {
//            sc = new Scanner(new File("exercise5.txt"));
...
//        String content="";
//        try {
//           content = new String(Files.readAllBytes(Paths.get("exercise5.txt")), "UTF-8");
//        } catch (IOException e) {
//            e.printStackTrace();
//        }
//        resultMod=content;
...
//        }
//        try(FileWriter fileWriter=new FileWriter("exercise5.txt",false))
//        {
...
//        try(BufferedReader br=new BufferedReader(new FileReader("exercise7.txt")))
//        {
//            String sCurrentLine;
...
//        }
//
//        try(FileWriter fileWriter=new FileWriter("exercise7.txt",false))
//        {
